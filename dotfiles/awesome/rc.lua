...
beautiful.init(awesome_dir .. "zenburn/theme.lua")
...
hyper = { modkey, "Control", "Shift", alt}
...
vicious.register(battwidget, vicious.widgets.bat, 'Batt: $2% │ ', 5, 'BAT0')

-- Alsa
alsawidget = wibox.widget.textbox()
vicious.register(alsawidget, vicious.widgets.volume, 'Vol: $2 $1% │ ', 5, 'Master')
...
vicious.register(memwidget, vicious.widgets.mem, 'Mem: $2MB │ ', 5)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control"   }, "s",  function ()
        awful.util.spawn("/usr/bin/env i3lock-fancy") end),
    awful.key({ modkey, "Shift"   }, "s",  function ()
        awful.util.spawn("rofi -show window") end),
    awful.key(hyper, "s", function ()
